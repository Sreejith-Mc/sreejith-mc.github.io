...
| Toolbar tools (V/F/R/P/T/C) | Working canvas tools: Move, Frame, Rectangle, Pen (freehand), Text, Comment. Pick one (or press its shortcut), then draw/type/click on the page. Everything you make is draggable + deletable in Move mode; Esc returns to Move |
